...
import { ChevronDownIcon, HambugerIcon, TBALogo } from "./assets/Icons";
...
export default function Home() {
  ...
  return (
    <main className="flex h-[100vh] w-full justify-center bg-slate-100">
      <div className="h-full w-full bg-banner bg-cover lg:min-w-[50rem] lg:max-w-[50rem]">
        <div className="px-5 py-5">
          <div className="z-10 w-fit cursor-pointer rounded-full border-2 border-transparent bg-customGray p-2 opacity-[0.7] hover:opacity-[0.9]">
            <TBALogo />
          </div>
        </div>

        <div className="mt-[30px] h-[87%] w-full max-w-[1080px] space-y-3 overflow-y-auto rounded-t-xl border-t-0 bg-white px-5 pt-5 no-scrollbar">
              ...
              {Array(4)
                ...
                .map((_, i) => (
                  ...
                  >
                    ...
                    <div>
                      <p className="text-base text-[#979797]">0.00</p>
                    </div>
                  </div>
                ))}
            </div>
